...
class Config {
    ...
    constructor(pkg, options, basePath) {
        ...
        this.env = process.env.ENVIRONMENT || process.env.NODE_ENV || this.options.host || 'development';
        ...
        this.metricOptions.flushEvery = this.options.flushEvery || (6 * 1000);

        this.metrics = this.options.metrics || Object.create(null);
        this.metrics.provider = this.options.metrics.provider || null;
        this.metrics.options = this.options.metrics.options || this.metricOptions;
